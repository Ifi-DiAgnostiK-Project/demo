...
Das vorliegende Quiz wiederholt Wissen aus den Modulen **G-TSM, TSM 1 und TSM 2** zum Bedienen der genannten Maschinen.

Damit haben Sie eine **optimale Vorbereitung** für Ihre fachpraktischen Aufgaben.
</div>
...
Typische Arbeitsunfälle drehen sich meist um eine Handvoll immer wiederkehrender Muster (v. a. an Maschinen und bei manueller Arbeit):

<!-- class="explained" -->
1. **Kontakt mit bewegten Teilen**

- Hineingreifen in **drehende** Werkzeuge (Fräser, Sägeblätter, Bohrer), z. B. beim Späneentfernen mit der Hand oder dem Lappen
- Einziehen von Kleidung, Handschuhen, Schmuck oder langen Haaren in rotierende Teile
<br>
2. **Wegschleudern von Werkstücken und Teilen**
- Schlecht gespanntes oder falsch geführtes Werkstück wird aus der Hand bzw. aus der Spannung gerissen.
- Wegfliegende Teile treffen Bediener oder Umstehende im Kopf‑ oder Oberkörperbereich.
<br>
...
- Ausrutschen auf Öl, Spänen oder Staub, insbesondere in schlecht gereinigten Bereichen.
<br>
5. **Unfälle durch falsche oder fehlende persönliche Schutzausrüstung**
<br>
6. **Wegeunfälle**
- auf dem Arbeitsweg oder nach Hause
- umfassen ca. 18-20% aller Arbeitsunfälle
...
> Hinweise zur Lösung für diese und die nachfolgenden Aufgaben finden Sie im TSM-Lehrgangsbegleitheft, S. 6-7.
...
<!-- class="highlight" -->
Wie ist mit einer Maschine zu verfahren, die sicherheitstechnische Mängel aufweist, z. B. ein defektes Stromkabel?
...
<!-- class="highlight"-->
Welcher Personenkreis hat Gehörschutzmittel im Betrieb zur Verfügung zu stellen?\
...
<!--style="background-color:#FFA500;color: white"-->
> Hinweise zur Lösung für die Aufgabe finden Sie im TSM-Lehrgangsbegleitheft, S. 9.

### Absturzsicherung - Aufgabe 1
...
notwendig.
********************
Die Lösung lautet: 2 m. - Siehe dazu das TSM-Lehrbuch, S. 166.
********************
...
<!--style="background-color:#FFA500;color: white"-->
> Hinweise zur Lösung für die Aufgabe finden Sie im TSM-Lehrgangsbegleitheft, S. 166-167.


### Absturzsicherung - Aufgabe 2

<!-- class="highlight" -->
Welche Absturzsicherung kann bei kurzfristigen Montagearbeiten mit Absturzgefahr, z. B. Fenstereinbau, genutzt werden?\
...
<br>
Sicherheit im Umgang mit handgeführten Maschinen beruht auf Übung, Aufmerksamkeit – und der persönlichen Verantwortung jedes Einzelnen.
<br>
...
<!-- class="highlight" -->
Welche Persönliche Schutzausrüstung ist beim Ablängen von Schnittholz (bei sicherer Werkstückauflage) mit der handgeführten Kettensäge mindestens erforderlich?
...
data-max-trials="3"
-->
- [( )] Schutzhelm mit Gesichtsschutz, Schnittschutzjacke, Schnittschutz im Beinbereich
- [( )] Schutzhelm mit Gesichtsschutz, Schnittschutzjacke, Schnittschutz im Beinbereich, Schnittschutzschuhe
...
<!--style="background-color:#FFA500;color: white"-->
> Hinweise zur Lösung für diese und die nachfolgende Aufgabe finden Sie im TSM-Lehrgangsbegleitheft, S. 155-156.
...
<!-- class="highlight" -->
Welche Sägenkette ist für das Ablängen von Schnittholz zu verwenden?
...
data-max-trials="3"
-->
- [( )] Sägekette mit großem Spanraum
- [( )] eine gut geschärfte Sägenkette
...
<!-- style="font-weight: bolder; font-size: 11pt; color: black"-->
Die Faustformel zum Errechnen der Schnittgeschwindigkeit lautet:


<!--style="font-size: large;font-weight: bold"-->
$v$ $\text{=}$ $\frac{r {\cdot} {n}}{1000}$
<br> <br>

<!-- class="highlight" -->
Welche Maßeinheit hat  $r$  in dieser Formel?
...
<br>
**Hinweis**:\
$n$  wird in dieser Formel mit  $U/min$  angegeben.
...
<!--style="background-color:#FFA500;color: white"-->
> Hinweise zur Lösung für diese Aufgabe finden Sie im TSM-Lehrgangsbegleitheft, S. 15.
...
<!-- class="highlight" -->
Bei welchem Arbeitsgang darf der Spaltkeil an der Tisch- und Formatkreissäge ausgebaut werden?
...
<!--style="background-color:#FFA500;color: white"-->
> Hinweise zur Lösung für diese und die nachfolgende Aufgabe finden Sie im TSM-Lehrgangsbegleitheft, S. 11-35.
...
An einer Tisch- und Formatkreissäge ist die Drehzahl einzustellen.\
<br>
Folgende Angaben sind bekannt:
* Das verwendete Sägeblatt hat einen Durchmesser von 300 mm.
* Die Schnittgeschwindigkeit beträgt  $\sim{54}$ m/s.
...
einzustellen.
********************
Die Lösung lautet: 9.000 U/min. - Siehe dazu das TSM-Lehrbuch, S. 15.
<br>
Die "Faustformel" basiert auf dieser Berechnungsformel:

<!--style="font-size: large;font-weight: bold"-->
$v$ $\text{=}$ $\frac{r {\cdot} {n}}{1000}$

Beim Rechnen mit der "Faustformel"<!-- style="font-weight: bolder; font-size: 11pt; color: orange;"-->

- bleiben die Maßeinheiten unberücksichtigt.
- Die "1.000" wird beim Rechnen gedanklich weggestrichen.
- Die beim Durchmesser angegebenen "mm" werden in "cm" umgerechnet.
- Zum errechneten Ergebnis werden die drei Nullen wieder hinzugefügt.

<!--style="font-weight: bold; color: black"-->
Damit ergeben sich folgende Rechnungsschritte:

1.  Die Formel lautet ohne die "weggestrichenen 1.000":  $v$<!--style="font-size: large;font-weight: bold; color: orange"--> $\text{=}$<!--style="font-size: large;font-weight: bold; color: orange"--> $r$<!--style="font-size: large;font-weight: bold; color: orange"--> $\cdot$<!--style="font-size: large;font-weight: bold; color: orange"--> $n$ <!--style="font-size: large;font-weight: bold; color: orange"-->
2.  Da der Radius $r$<!--style="font-size: large;font-weight: bold; Color: orange"--> benötigt wird, ist dieser mit Hilfe des gegebenen Durchmessers  $d$<!--style="font-size: large;font-weight: bold; color: orange"-->  zu berechnen:  $d$<!--style="font-size: large;font-weight: bold; color: orange"--> $\text{=}$ $300$ $mm$ $\text{=}$ $30$<!--style="font-weight: bold; color: orange"--> $cm$<!--style="font-weight: bold; color: orange"-->.
3.  $r$<!--style="font-size: large;font-weight: bold; Color: orange"--> berechnet sich aus:  $\frac{{d}}{2}$<!--style="font-size: large;font-weight: bold; color: orange"--> $\text{=}$<!--style="font-size: large;font-weight: bold; color: orange"--> $\frac{{30}}{2}$<!--style="font-size: large;font-weight: bold; color: orange"--> $\text{=}$<!--style="font-size: large;font-weight: bold; color: orange"--> $15$<!--style="font-weight: bold; color: orange"--> $\text{cm}$<!--style="font-weight: bold; color: orange"-->
...
### Bandsägeblatt - Aufgabe 1

<section class="flex-container border">
<div class="flex-child">

<!-- class="highlight" -->
Wo soll das Bandsägeblatt mit balliger Bandage laufen?
<br> <br>
...
<!--style="background-color:#FFA500;color: white"-->
> Hinweise zur Lösung für diese und die nachfolgende Aufgabe finden Sie im TSM-Lehrgangsbegleitheft, S. 41-53.

### Bandsägeblatt - Aufgabe 2
...
Es ist wichtig, die Sicherheitseinrichtungen (z. B. Schutzhauben, Vorschub, Anschläge) zu kennen, richtig einzustellen und konsequent zu benutzen.
...
<!-- class="highlight" -->
Beim Abrichten weisen die Werkstücke am hinteren Ende Einschläge auf.\
Was ist die Ursache?
<br> <br>
...
data-max-trials="3"
-->
- [( )] Der Fehler liegt in der Werkstückführung.
- [( )] Das Werkstück wurde zu schnell vorgeschoben.
- [(X)] Der Abnahmetisch ist zu tief eingestellt.
- [( )] Der Aufnahmetisch ist zu tief eingestellt.
********************
Der Abnahmetisch ist zu tief eingestellt; das verursacht unregelmäßige Einschläge hinten. - Siehe TSM-Lehrbuch S. 57-68.
********************
...
Es ist wichtig, die Sicherheitsvorkehrungen zu kennen:

- korrekte Werkzeugauswahl (z. B. mit BG-Test/MAN-Kennzeicnung)
- Einstellung von Anschlägen und Schutzvorrichtungen
- sichere Hand- und Körperhaltung
- Nutzung geeigneter Vorschubhilfen
...
<!-- class="highlight" -->
Die Tischfräsmaschine ist fertig aufgerüstet.\
Es ist nur noch die obere Werkzeugverdeckung einzustellen.\
Ergänzen Sie das Maß.
<br> <br>

<!-- style="font-weight: bolder; font-size: 11pt; color: black"-->
Die Werkzeugverdeckung soll den Schneidenkreis des Fräswerkzeuges im Arbeitsbereich um die Werkstückdicke überragen;
<br>
...
********************
Die Werkzeugverdeckung soll den Schneidenkreis des Fräswerkzeugs im Arbeitsbereich um die Werkstückdicke überragen; mindestens jedoch um 15 mm.. - Siehe TSM-Lehrbuch, S. 97.
********************
...
<!--style="background-color:#FFA500;color: white"-->
> Hinweise zur Lösung für diese und die nachfolgenden Aufgaben finden Sie im TSM-Lehrgangsbegleitheft, S. 83-115.
...
Für einen Handvorschub geeignete Fräswerkzeuge ist die Spandickenbegrenzung<!-- style="font-weight: bolder; font-size: 11pt; color: black"--> festgelegt.
...
<!-- class="highlight" -->
Was passiert, wenn die Schnittgeschwindigkeit und die Drehzahl bei einem Fräswerkzeug zu ~~hoch~~ sind?\
...
<!-- class="highlight" -->
Was passiert, wenn die Schnittgeschwindigkeit und die Drehzahl bei einem Fräswerkzeug zu ~~niedrig~~ sind?\
Ziehen Sie die richtigen Antworten in das Antwortfeld.
<br> <br>
...
*******************
Das Werkstück muss an der Rückschlagsicherung und vorn am Anschlag liegen. - Siehe auch TSM-Lehrbuch S. 103.
******************
...
- [( )] Die Spannlade ist auf Anordnung der Berufsgenossenschaft vorzuhalten.
- [( )] Unabhängig von der Werkstücklänge, habe ich ein Hilfsmittel zum sicheren Einspannen zu verwenden.
*******************
Die Spannlade ist zu verwenden, sobald das Werkstück in die Spannlade passt.. - Siehe auch TSM-Lehrbuch S. 103.
******************
...
<!-- style="font-size: 11pt; color: black;"-->
An einer Tischfräsmaschine ist die Drehzahl einzustellen.\
<br>
Folgende Angaben sind bekannt:
* Das verwendete Werkzeug hat einen Durchmesser von 140 mm.
* Es soll eine Schnittgeschwindigkeit von $\sim{43}$ m/s erreicht werden.
...
einzustellen.
********************
Die Lösung lautet: 6.100 U/min. - Siehe dazu das TSM-Lehrbuch, S. 93.
<br>
Die "Faustformel" basiert auf dieser Berechnungsformel:
...
1.  Die Formel lautet ohne die "weggestrichenen 1.000":  $v$<!--style="font-size: large;font-weight: bold; color: orange"--> $\text{=}$<!--style="font-size: large;font-weight: bold; color: orange"--> $r$<!--style="font-size: large;font-weight: bold; color: orange"--> $\cdot$<!--style="font-size: large;font-weight: bold; color: orange"--> $n$ <!--style="font-size: large;font-weight: bold; color: orange"-->
2.  Da der Radius $r$<!--style="font-size: large;font-weight: bold; Color: orange"--> benötigt wird, ist dieser mit Hilfe des gegebenen Durchmessers  $d$<!--style="font-size: large;font-weight: bold; color: orange"-->  zu berechnen:  $d$<!--style="font-size: large;font-weight: bold; color: orange"--> $\text{=}$ $140$ $mm$ $\text{=}$ $14$<!--style="font-weight: bold; color: orange"--> $cm$<!--style="font-weight: bold; color: orange"-->.
3.  $r$<!--style="font-size: large;font-weight: bold; Color: orange"--> berechnet sich aus:  $\frac{{d}}{2}$<!--style="font-size: large;font-weight: bold; color: orange"--> $\text{=}$<!--style="font-size: large;font-weight: bold; color: orange"--> $\frac{{14}}{2}$<!--style="font-size: large;font-weight: bold; color: orange"--> $\text{=}$<!--style="font-size: large;font-weight: bold; color: orange"--> $7$<!--style="font-weight: bold; color: orange"--> $\text{cm}$<!--style="font-weight: bold; color: orange"-->
...
### Einstellen eines Fräswerkzeugs
